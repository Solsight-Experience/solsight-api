...
export class DiscoveryService implements OnModuleInit {
    ...
    async getTrending(cluster: Cluster, dto: GetTrendingDto) {
        ...
        for (let w = startWindow; w <= endWindow; w++) {
            const windowKey = RedisService.KEYS.DISCOVERY_TRENDING_WINDOW(cluster, sort_by, w);
        ...
        const totalKey = RedisService.KEYS.DISCOVERY_TRENDING_TOTAL(cluster, sort_by);
